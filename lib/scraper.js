...
export async function scrapeWebsite(url) {
  ...
  return {
    ...
    has_google_ads:     html.includes('googleads.g.doubleclick.net') || html.includes("gtag('config', 'AW-") || html.includes('google_conversion_id') || html.includes('ads.google.com/pagead'),
