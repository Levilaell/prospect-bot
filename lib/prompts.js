...
1. [Nome do negócio] + observação incompleta
- Começar sempre com o nome
- Referenciar algo real
- NÃO explicar totalmente o problema
- Sugerir que existe algo errado
- Máximo 18 palavras
...
REGRAS CRÍTICAS:
- Evite afirmações absolutas (ex: "você perde clientes")
- Prefira sugestões leves (ex: "pode estar perdendo clientes")
